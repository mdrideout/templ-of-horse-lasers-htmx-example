    ...
    t.addIndirectExpression("possessive", function (e, t, r, n) {
      ...
      if (
        ...
        (n.type === "symbol" &&
          ...
          (r.currentToken().type === "IDENTIFIER" || r.currentToken().type === "ATTRIBUTE_REF" || r.currentToken().type === "STYLE_REF"))
      ) {
        if (i) {
          r.requireToken("s");
        }
      ...
      if (r.matchToken("for")) {
        ...
        do {
          ...
          if (a.type === "NUMBER" || a.type === "L_PAREN") {
            ...
            i.push({ name: e.requireElement("dotOrColonPath", r, "Expected event name").evaluate(), args: v(r) });
          }
        } while (r.matchToken("or"));
        if (r.matchToken("from")) {
          var o = e.requireElement("expression", r);
    ...
    e.addCommand("measure", function (e, t, r) {
      ...
      return {
        ...
        op: function (e, r) {
          ...
          var o = { top: r.scrollTop, left: r.scrollLeft, topMax: r.scrollTopMax, leftMax: r.scrollLeftMax, height: r.scrollHeight, width: r.scrollWidth };
          e.result = {
            x: a.x,
            y: a.y,
            left: a.left,
